...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public MyCustomAdapter(Context context, List<CountryModel> coutryModelList) {
        super(context, R.layout.list_custom_item, coutryModelList);

        this.context = context;
        this.countryModelList = coutryModelList;
        this.countryModelListFiltered = coutryModelList;
